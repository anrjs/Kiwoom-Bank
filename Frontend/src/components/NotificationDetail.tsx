...
import { ArrowLeft, Home, TrendingDown, TrendingUp, AlertTriangle, Loader2 } from "lucide-react"; // :느낌표:️ Loader2 추가
import { Button } from "./ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "./ui/card";
import { Badge } from "./ui/badge";
import kiwoomLogo from "figma:asset/7edd7880e1ed1575f3f3496ccc95c4ca1ab02475.png";
import type { Notification } from "./NotificationInbox"; // :느낌표:️ Notification 타입 import
const API_BASE = import.meta.env.VITE_API_BASE_URL || "http://localhost:8000";
const POLL_MS = 30 * 1000; // :느낌표:️ 상세 페이지는 30초마다 새로고침
// :느낌표:️ [수정] props 인터페이스 정의
...
export function NotificationDetail({
  ...
  // :느낌표:️ [수정] 등급 비교 로직 (현재 등급 vs 알림 당시 등급)
